-- The boards show the aircraft's registration mark with its ICAO type
-- designator instead of the tower short number and type name. New OUT
-- column → drop and re-create (body from 20260904010000 plus
-- type_icao_designator).
