-- The dashboard accordion's web view shows flight details beyond what
-- the board rows already carry: cruising speed, cruising level, and
-- total EET. Changing a function's OUT columns requires dropping it
-- first.
