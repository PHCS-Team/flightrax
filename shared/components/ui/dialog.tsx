...
import { useVisualViewportCenter } from "@/shared/hooks/use-visual-viewport-center"
...
// Controllable wrapper so the phone's Back button can close the dialog
...
function DialogContent({
  ...
  // Stays centred; while the mobile keyboard is up it re-centres inside
  // the visible area instead of hiding behind the keyboard.
  const keyboardStyle = useVisualViewportCenter()
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-row items-center justify-end gap-2 rounded-b-xl border-t bg-muted/50 p-4 *:flex-1 sm:*:flex-initial",
        className
      )}
      {...props}
    >
