...
function SheetContent({
  ...
  // Only a bottom sheet is affected: the other sides are not pinned to the
  // edge the keyboard rises from.
  const keyboardStyle = useVisualViewportBottomInset()
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        style={side === "bottom" ? { ...keyboardStyle, ...style } : style}
        {...props}
      >
        {children}
        {showCloseButton && (
