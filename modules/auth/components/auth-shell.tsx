      ...
      <main className="grid min-h-screen gap-y-8 lg:grid-cols-[1fr_0.9fr] lg:gap-y-0">
        <section className="flex flex-col justify-between p-8 pb-0 sm:p-12">
          ...
          <div className="max-w-xl pt-12 sm:pb-16">
            ...
            <h1 className="mt-2 sm:mt-5 text-4xl font-semibold leading-12 sm:leading-17.5 tracking-tight sm:text-6xl">
              {title}
            </h1>
        ...
        >
          <div
            className={cn(
              ...
              surface === "glass"
                ? "max-w-md border-y border-primary-foreground/20 bg-primary-foreground/10 p-6 shadow-sm backdrop-blur sm:rounded-3xl sm:border sm:bg-primary-foreground/15 [&_.text-destructive]:text-red-200 [&_.text-foreground]:text-primary-foreground [&_.text-muted-foreground]:text-primary-foreground/70 [&_input]:border-primary-foreground/20 [&_input]:bg-primary-foreground/95 [&_input]:placeholder:text-muted-foreground [&_input[aria-invalid=true]]:border-red-200/60 [&_input[aria-invalid=true]]:ring-red-200/25 **:data-[slot=select-trigger]:border-primary-foreground/20 **:data-[slot=select-trigger]:bg-primary-foreground/95 [&_[data-slot=select-trigger][aria-invalid=true]]:border-red-200/60 [&_[data-slot=select-trigger][aria-invalid=true]]:ring-red-200/25 [&_[data-slot=select-trigger][data-placeholder]]:text-muted-foreground"
                : "max-w-xl",
              contentClassName,
            )}
          >
